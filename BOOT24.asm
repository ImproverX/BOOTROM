...
L_00D4:	CALL    L_CHDD	; проверка наличия ХДД
	JNZ     L_067B	; >>> переход на загрузку с диска
...
L_FBL1:	MVI  A, 0C3h	; =JMP		<<<<<<<<<<<<<<<<<
	STA     00000h
	SHLD    00001h
L_03E4:	CALL    L_015A	; >> заполнение блоков, D=количество
	INR  H
	DCR  D
	JNZ     L_03E4
	RET
